...
//			{ lightness: 1 }
	...
	,{
      ...
      downloadUrl("../wp-content/themes/areview-child/scripts/maps1.xml", function(data) {
...
//          var type = markers[i].getAttribute("type");
      ...
      downloadUrl("../wp-content/themes/areview-child/scripts/polylines/route2_polyline.xml", function(data) {
    var xml = data.responseXML;
